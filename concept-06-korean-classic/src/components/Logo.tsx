// EGO 워드마크 — 공식 CI 수령 시 교체
// 클래식 한국 기업 헤더 문법: 영문 워드마크 + 공식 영문 의미("Energe Goes On") 병기
...
export function Logo({ variant = "default", className = "" }: LogoProps) {
  ...
  return (
    <span className={`inline-flex items-center gap-2.5 ${className}`}>
      {/* 단순 기하 악센트 — 이어지는 라인 모티프 (복잡한 심볼 제작 금지) */}
      ...
      <span className="flex flex-col leading-none">
        <span
          className={`text-[1.5rem] font-extrabold tracking-[0.04em] ${
